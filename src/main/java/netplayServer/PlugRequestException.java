...
/**
 * Exception thrown when a problem occurred plugging into a console. The exception will contain a
 * list of port rejections, useful for returning to a client. If rejections are null, then no ports
 * were requested.
 */
